/* Fakes the Atom TextEditor class. This can be used to make Atom packages run as command line scripts. */
/* Example 
const editor = new TextEditor();
await editor.load(fileName); // Load file in editor
const myPackage = new MyPackage(editor); // The original Atom package
myPackage.runPackageCommand(); // Run command
await editor.save(); // Save file
*/
...
class TextEditor {
  ...
  // MODIFIED TO FAKE REQUIRED BEHAVIOUR
  constructor() {
    this.emitter = { emit: () => {} };
  ...
  // EVERYTHING BELOW IS NOT MODIFIED (except for deleting unused methods)
